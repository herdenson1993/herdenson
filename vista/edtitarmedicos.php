...
<div class="container">
   ...
   include'../conectar/conectar.php';
       ...
       $consulta=mysqli_query($conectar, "SELECT * FROM medicos where id='$id'") or die(mysqli_error($conectar));
	...
	<input type="hidden" name="id" value="<?php echo $row['id'];?>">	
		...
		<button type="submit" name="boton" value="Editar" class="btn btn-primary">Editar</button>
