...
<table class="table table-bordered table-hover">
	...
	<?php
       ...
       $consulta=mysqli_query($conectar, "SELECT * FROM pacientes") or die(mysqli_error($conectar));
       ...
       <td><?php echo $row['id']?></td>
		...
		<td> <a href="eliminarpacientes.php?eliminarpacientes&id=<?php echo $row['id']?>" class="btn btn-primary">Eliminar</a> <a href="editarpacientes.php?view=editarpacientes&id=<?php echo $row['id'];?>" class="btn btn-primary">Editar</a></td>
