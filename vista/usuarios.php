...
<table class="table table-bordered table-hover">
	...
	<?php
       ...
       $consulta=mysqli_query($conectar, "SELECT * FROM usuarios") or die(mysqli_error($conectar));
       ...
       <td><?php echo $row['id']?></td>
    	...
    	<td> <a href="eliminarusuarios.php?eliminarusuarios&id=<?php echo $row['id']?>" class="btn btn-primary">Eliminar</a> <a href="editarusuarios.php?Views=editarusuarios&id=<?php echo $row['id'];?>" class="btn btn-primary">Editar</a> </form></td>
