...
<section class="jumbotron">
   ...
   include'../conectar/conectar.php';
       ...
       $consulta=mysqli_query($conectar, "SELECT * FROM pacientes WHERE id='$id'") or die(mysqli_error($conectar));
	...
	<input type="hidden" name="id" value="<?php echo $row['id'];?>">	
		...
		<div class="form-group">
			...
			<input type="text" name="Historial" value="<?php echo $row['Historial'];?>" class="form-control" required>
		</div>

		<button type="submit" name="boton" value="Editar_1" class="btn btn-primary">Editar</button>
